...
TEST_F(ADCETest, SimpleDeadCodeRemoval) {
    ...
    auto deadVal1 = builder->createAdd(builder->getInt32(10), 
                                       builder->getInt32(20), 
                                       "dead1");
    auto deadVal2 = builder->createMul(deadVal1, 
                                       builder->getInt32(2), 
                                       "dead2");

    // Create live code
    auto liveVal = builder->createAdd(builder->getInt32(5), 
                                      builder->getInt32(10), 
                                      "live");
...
TEST_F(ADCETest, DeadCodeWithComplexDependencies) {
    ...
    auto dead4 = builder->createAdd(dead3, dead2, "dead4");
...
TEST_F(ADCETest, StoreInstructionsAlwaysLive) {
    ...
    auto val = builder->createMul(builder->getInt32(5), 
                                  builder->getInt32(6), 
                                    "val");
    builder->createStore(val, ptr);

    // More dead code after store
    auto dead2 = builder->createSub(dead1, 
                                    builder->getInt32(5), 
                                    "dead2");
...
TEST_F(ADCETest, ConditionalBranchWithDeadCode) {
    ...
    // Dead code in entry
    auto dead_entry = builder->createAdd(builder->getInt32(1), 
                                        builder->getInt32(2), 
                                        "dead_entry");
    ...
    auto dead_true = builder->createMul(trueVal, 
                                       builder->getInt32(2), 
                                       "dead_true");
    ...
    auto dead_false = builder->createAdd(falseVal, 
                                        builder->getInt32(5), 
                                        "dead_false");
    builder->createBr(mergeBB);
...
TEST_F(ADCETest, CallInstructionsAlwaysLive) {
    ...
    auto callResult = builder->createCall(calleeFunc, 
                                         {builder->getInt32(42)}, 
                                         "call_result");

    // Dead arithmetic after call
    auto dead2 = builder->createMul(dead1, 
                                   builder->getInt32(2), 
                                   "dead2");
...
TEST_F(ADCETest, PartiallyDeadComputationChain) {
    ...
    auto val1 = builder->createAdd(param, 
                                   builder->getInt32(10), "val1");
    auto val2 = builder->createMul(val1, 
                                   builder->getInt32(2), "val2");
    auto val3 = builder->createSub(val2, 
                                   param, "val3");
    auto val4 = builder->createAdd(val3, 
                                   val1, "val4");  // Uses val3 and val1
    
    // Store val3 (makes val1, val2, val3 live, but not val4)
    builder->createStore(val3, ptr);
    
    // Create another dead chain
    auto dead1 = builder->createMul(val4, 
                                    builder->getInt32(3), "dead1");
    auto dead2 = builder->createAdd(dead1, 
                                    val2, "dead2");
